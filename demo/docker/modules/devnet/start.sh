...
#   2. Backend built: make build-backend (from demo directory)
#   3. Frontend built: make build-frontend (from demo directory)
...
if [ ! -f "${DEMO_DIR}/backend/build/distributions/backend.tar" ]; then
