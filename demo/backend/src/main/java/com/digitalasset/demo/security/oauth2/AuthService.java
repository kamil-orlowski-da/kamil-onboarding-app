...
import com.digitalasset.demo.security.*;
...
final class AuthService
    implements AuthenticatedPartyProvider, AuthenticatedUserProvider, TokenProvider {
  ...
  public Optional<AuthenticatedUser> getUser() {
    if (!(SecurityContextHolder.getContext().getAuthentication()
            instanceof OAuth2AuthenticationToken auth)
