...
public class TenantPropertiesRepository {
  ...
  /**
   * Save (or overwrite) a tenant's extra properties. Called when we create a new tenant
   * registration at runtime, etc.
   */
  ...
  public void removeTenant(String tenantId) {
    if (tenants.remove(tenantId) == null) {
      throw new NoSuchElementException(
          String.format("No tenant found for tenantId = %s.", tenantId));
    }
  }
}
