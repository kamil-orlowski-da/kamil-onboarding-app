...
application {
    mainClass = "com.digitalasset.demo.App"
}

tasks.withType<Jar> {
    manifest {
        attributes["Main-Class"] = "com.digitalasset.demo.App"
...
openApiGenerate {
    ...
    apiPackage = "com.digitalasset.demo.api"
}
...
tasks.register<GenerateTask>("openApiGenerateMetadata") {
    ...
    apiPackage.set("com.digitalasset.demo.tokenstandard.openapi.metadata")
    modelPackage.set("com.digitalasset.demo.tokenstandard.openapi.metadata.model")
    configOptions.set(
        mapOf(
            "library" to "native",
...
tasks.register<GenerateTask>("openApiGenerateAllocation") {
    ...
    outputDir.set("$buildDir/generated-token-standard-openapi")
    apiPackage.set("com.digitalasset.demo.tokenstandard.openapi.allocation")
    modelPackage.set("com.digitalasset.demo.tokenstandard.openapi.allocation.model")
    configOptions.set(
        mapOf(
            "library" to "native",
            "dateLibrary" to "java8",
